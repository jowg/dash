...
class WidgetConfigScatter extends React.Component {
  constructor(props) {
    super();
  ...
  render() {
    ...
    return (
        ...
        <BorderTopPlusClose onClose={this.cancelConfig} title='Scatter Widget Configuration'/>
